...
#ifndef HSLIDARDATAN_HH
#define HSLIDARDATAN_HH
...
#define HSLIDARDATA_MSG_TYPE 13003
...
class HSLIDARDATA_MSG : public NMLmsgEx
{
public:
    //Constructor
    HSLIDARDATA_MSG(){};
...
//    void update(CMS *);
    ...
    PointCoordinate128 HSData[PACKETNUM128*2][128];
...
//extern int HSLidarDataFormat(NMLTYPE, void *, CMS *);
